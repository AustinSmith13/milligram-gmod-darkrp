...
aMenu.SubTitle 				= "Like the good ol days"
...
aMenu.AllowedTabs["Ammo"] 		= false
aMenu.AllowedTabs["Rules"] 		= false
...
aMenu.UseHTMLRules 			= true

--Link to a rules.txt file if the above is set to false, if not link to your normal rules webpage
aMenu.RulesLink = "https://docs.google.com/document/d/1L0dGJwC-ktSle8sHJBuN3aZrWL0AzwOv1kaBE-suS8o/edit?usp=sharing"
